...
console.log(sketch);
document.getElementById("drawn").innerHTML = "<p id='con'>Sketch to be Drawn : "+sketch+"</p>";
...
function updateCanvas() {
    ...
    sketch= quick_draw_data_set[random_no];
    console.log(sketch);
    document.getElementById("drawn").innerHTML = "<p id='con'>Your Sketch - "+sketch+"</p>";
}
...
function gotResults(error, results) {
    ...
    document.getElementById("yr_sketch").innerHTML= "Your Sketch : " + drawn_sketch;
